...
| PA073 | NEW NBA G2 詳細スタッツ補填 | Session_51 で形式記入のみ済の NBA #30 ATL d. NYK G2 / #32 MIN d. DEN G2 を WebSearch で詳細補填 → rule_linked 確定。P018/P019 兄弟パターン (PO G1 home favorite fade) との関連検討要。 | PENDING | 中 | 次セッション |
