...
| PA094 | Session_58 新規 GO 6件 結果追跡 | **Session_59 部分反映 2026-04-25**: Warriors HIT (+0.45u) 反映済。残: Khachanov/FAA/Mensik (ATP R2 4/25 進行中) + Mboko (WTA R2) + Manly @1.38 (4/26) → 全試合決着後に再確認 | WAITING | 最高 | 4/25-26 全試合決着後 |
| PA095 | Session_58 CAUTION_MARGIN 2件追跡 | Shapovalov @1.55 / Ruud @1.42 (4/25 進行中) → 試合決着後に prediction_hit 反映 | WAITING | 高 | 4/25 試合決着後 |
| PA096 | Session_58 Q4_upset_watch 5件追跡 | **Session_59 部分反映 2026-04-25**: LAL G3 HIT (UPSET prediction 当たり) / SAS G3 HIT (Wemby OUT でも勝利、P024 反証) / ANA G3 HIT (P025/N021 evidence 3/3) / MTL G3 HIT (P018 候補) records 反映済。Osaka vs Kalinina 残 | WAITING | 中 | 4/26 Osaka 試合決着後 |
...
| PA098 | Session_58 NHL G3 結果追跡 | **Session_59 完了 2026-04-25**: CAR 2-1 OTT (CAR sweep 3-0 close) / MTL 3-2 OT TBL (Hutson OT, P018 evidence 3/3 候補) / UTA 4-2 VGK (Crouse 2G) / ANA 7-4 EDM (P025/N021 evidence 3/3 到達). 全 records 反映完了。PHI G4 close-out は未開催 (4/27) | DONE | 高 | 完了 2026-04-25 (PHI G4 別 PA で追跡) |
| PA099 | Session_58 NBA G3/G4 結果追跡 | **Session_59 部分反映 2026-04-25**: BOS 108-100 PHI HIT pred / LAL 112-108 OT HOU MISS pred (Q4 UPSET HIT) / SAS 120-108 POR MISS pred (Wemby OUT) / ATL 109-108 NYK MISS pred (P028 evidence 2/3). 残 4試合 (ORL-DET G3 4/25 ET 13:00 / PHX-OKC G3 4/25 ET 15:30 / MIN-DEN G4 4/25 ET 20:30 / TOR-CLE G4 4/27) → 試合決着後に追加反映 | WAITING | 中 | 4/26 朝 JST + 4/27 |
| PA100 | Session_59 ルール実装判断 | **P025/N021 (NHL xGF% higher team 優先) evidence 3/3 到達** (A028 MIN G1 + A030 ANA G2 + A030_g3 ANA G3) → 次スクリーニング前に rules_nhl.json N021 として実装判断必要。**P028 (NBA G2/G3 home fav 4Q execution collapse) evidence 2/3 到達** (G2 NYK 4Q 5-22 + G3 NYK home 12.5s clutch 失敗) → 残 1件で N_NBA_new4 実装 | PENDING | 高 | 次スクリーニング前 |
| PA101 | Session_59 残試合決着後の一括反映 | ATP Madrid R2 5件 + Manly + NBA G3/G4 残 4件 + Premiership R14 / SL R9 / Top14 R23 / UFL W6 / AHL Calder Cup PO の試合決着後に一括 records 反映 + cumulative/dashboard_stats/dashboard.html 同期 | WAITING | 最高 | 全試合決着後 (4/26-28 想定) |
| PA102 | Session_60 ALERT 4件 rule_linked 補填 DONE | NBA HOU-LAL G3 (P024_subset + A036 cand) / NBA POR-SAS G3 (P024 limit exposed) / NBA NYK-ATL G3 (P028 evidence 2/3) / NHL MTL-TBL G3 (P018 evidence 3/3 到達 → N019 implement 候補)。health_check 16/16 OK | DONE | 最高 | 完了 2026-04-25 |
| PA103 | GEN007 提案 #4 UPSET_PICK_Lite 採否判断 | **【提案】** 現行 UPSET_PICK 閾値 (UF≥3 + div≥15pp + stake 1u) は Phase2 移行後7日で発動 0件。観察上 UF=2 + div 10-15pp は複数発生 (Madrid R1 Tirante UPSET / SAS G3 Wemby OUT 等)。**Lite 案**: UF≥2 + div≥10pp + **stake 0.5u** + tier `upset_pick_lite` 新設。GO/CAUTION/UPSET_PICK と排他、Q4_upset_watch とは共存。**期待効果**: 観察データ収集加速 + 半額 stake で損失リスク管理。**工数**: 1セッション (rules_*.json 更新 + framework.json GEN005 衝突解消テーブル拡張 + records タグ追加 + sync_dashboard.py panel 追加)。**ユーザー判断依頼: 採択 / 却下 / 保留** | PENDING | 高 | ユーザー判断待ち |
