...
|---|---|---|---|---|---|
| 1 | Bristol 52-19 Newcastle Premiership | 区分1 (full_record) | completed | パターンA | scope内大会 / regular round / 試合成立 / 市場fav 敗戦 (UPSET) |
| 2 | Northampton 41-38 Bath Premiership | 区分1 (full_record) | completed | パターンA | scope内 / 既 records 登録 (date 訂正のみ必要 4/26→4/25) |
...
| 7 | HOU 115-96 LAL G4 (NBA Playoffs) | 区分1 (full_record) | completed | パターンB | scope内 / Playoffs / 市場fav LAL 敗戦 (UPSET) |
...
- **パターンB (新規追加 / 4件)**: #3 Swiatek retire (upset_patterns A044 のみ登録) / #6 TOR-CLE G4 (新規追加) / #7 HOU-LAL G4 (records line 1614 事後構築 / prediction_basis_construction_note 付与) / #9 Pliskova-Mertens (records line 3027 新規追加 + retrofit)
- **パターンC (第3 のパターン / screening_log 痕跡再構築 / 1件)**: #5 PHI G4 vs PIT (records line 1985 / screening_log _58 痕跡から prediction_confidence/odds/tier/quadrant 4要素復元)
...
- **【議題4 で訂正予定】** #1 Bristol-Newcastle / #2 Northampton-Bath / #7 HOU-LAL G4 計3件の「根拠」列に誤記述あり (#1: 市場fav BRI が 33点差大勝 = HIT / #2: 市場fav NSA が 3点差薄勝ち = HIT + confidence_drift=high 候補 / #7: 市場fav は HOU で HOU が 19点差大勝 = HIT)。本テーブル「根拠」列は議題3 step3 では **現行記述維持** (論点5 確定方針)。議題4 で訂正実施予定 (議題3 改訂内容 = 9-2 SOP の (a)-(d) フローによる訂正運用テストとして実証)。
